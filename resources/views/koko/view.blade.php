...
<div class="row">
    ...
    <div class="post-module hover">
      ...
      <div class="post-content">
        ...
        <div class="post-meta"><span class="timestamp"><i class="fa fa-clock-o"></i> {{$art->timestamps}} day ago</span><span class="comments"><i class="fa fa-comments"></i><a href="{{ "/profil/".$art->user->id   }}">by:{{$art->user->name   }}</a></span></div>
