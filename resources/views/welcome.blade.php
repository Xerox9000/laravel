...
<html>
	...
	<body>
		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					<h1>Problem Solving <span><strong>Redefiend.<strong><br /></h1>
					<ul class="actions">
						<li><a href="{{ url('/view')}}" class="button alt">Get Started</a></li>
					</ul>
				</div>
			</section>
		...
		<!-- Footer -->
			<section id="footer">
				<div class="inner">
					...
					<div class="copyright">
						TEAM : EL KRAIMI El Mehdi | FARES Salah-Eddine | GHARABTI Ahmed<br/>2018
					</div>
				</div>
			</section>
